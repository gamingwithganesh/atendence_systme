...
import { createSlot, getTimetableForClass, getTimetableForTeacher, deleteSlot, moveSlot } from '../controllers/timetableController.js';
...
router.post('/move', protect, hodOrAdmin, moveSlot);
